...
function M.exec(opt, cacheFile)
   ...
   local _trainData = convertToTensor({
   ...
   trainData.data = _trainData.data[{{1,45000},{},{},{}}]
   trainData.labels = _trainData.labels[{{1,45000}}]
   validData.data = _trainData.data[{{45001,50000},{},{},{}}]
   validData.labels = _trainData.labels[{{45001,50000}}]
