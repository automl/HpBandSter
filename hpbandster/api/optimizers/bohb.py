...
from hpbandster.config_generators.bohb import BOHB as CG_BOHB
...
class BOHB(Master):
	...
	def get_next_iteration(self, iteration, iteration_kwargs={}):
		...
		return(SuccessiveHalving(iter_number=iteration, num_configs=ns, budgets=self.budgets[(-s-1):], config_sampler=self.config_generator.get_config, **iteration_kwargs))
